...
> Snapshot 1
    ...
    .story:nth-child(1) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .p-2:nth-child(1) > .d-lg-flex > .d-lg-flex␊
    .story:nth-child(1) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(1) .story-title:nth-child(1)␊
    .story:nth-child(1) .f6:nth-child(2)␊
    .story:nth-child(2)␊
    .col-sm-3:nth-child(2) > .story-link␊
    .story:nth-child(2) .position-relative␊
    .story:nth-child(2) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .p-2:nth-child(2) > .d-lg-flex > .d-lg-flex␊
    .story:nth-child(2) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(2) .story-title:nth-child(1)␊
    .story:nth-child(2) .f6:nth-child(2)␊
    .story:nth-child(3)␊
    .story:nth-child(3) > .d-lg-flex␊
    .story:nth-child(3) .position-relative␊
    .story:nth-child(3) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .col-sm-3:nth-child(3) > .story-link--customer > .d-lg-flex␊
    .story:nth-child(3) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(3) .story-title:nth-child(1)␊
    .story:nth-child(3) .f6:nth-child(2)␊
    .story:nth-child(4)␊
    .col-sm-3:nth-child(4) > .story-link␊
    .story:nth-child(4) .position-relative␊
    .story:nth-child(4) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .p-2:nth-child(4) > .d-lg-flex > .d-lg-flex␊
    .story:nth-child(4) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(4) .story-title:nth-child(1)␊
    .story:nth-child(4) .f6:nth-child(2)␊
    .story:nth-child(5)␊
    .col-sm-3:nth-child(5) > .story-link␊
    .story:nth-child(5) .position-relative␊
    .story:nth-child(5) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .p-2:nth-child(5) > .d-lg-flex > .d-lg-flex␊
    .story:nth-child(5) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(5) .story-title:nth-child(1)␊
    .story:nth-child(5) .f6:nth-child(2)␊
    .story:nth-child(6)␊
    .story:nth-child(6) > .d-lg-flex␊
    .story:nth-child(6) .position-relative␊
    .story:nth-child(6) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .col-sm-3:nth-child(6) > .story-link--customer > .d-lg-flex␊
    .story:nth-child(6) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(6) .story-title:nth-child(1)␊
    .story:nth-child(6) .f6:nth-child(2)␊
    .story:nth-child(7)␊
    .col-sm-3:nth-child(7) > .story-link␊
    .story:nth-child(7) .position-relative␊
    .story:nth-child(7) > .story-link:nth-child(1) .d-block:nth-child(1)␊
    .p-2:nth-child(7) > .d-lg-flex > .d-lg-flex␊
    .story:nth-child(7) .d-lg-flex:nth-child(2) > .width-full:nth-child(1)␊
    .story:nth-child(7) .story-title:nth-child(1)␊
    .story:nth-child(7) .f6:nth-child(2)␊
